...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', '-d',
                        type=str,
                        required=True,
                        help='name of the dataset of the recorded experiment - '
                             'used only for naming the resulting files.')

    parser.add_argument('--output-dir', '-o',
                        type=str,
                        help='the directory to which the results will be stored '
                             '(default: ./<dataset>_max_z_projection_results)')
